    ...
    switch(sButtonName)
      ...
      case "Preview":
        if(this.btnPreview)
          ...
          sHTMLDropMenus+="<table class=\"Preview\" id=dropPreview"+this.oName+" cellpadding=0 cellspacing=0 "+
      ...
      case "StyleAndFormatting":
        ...
        if(this.btnTextFormatting||this.btnParagraphFormatting||this.btnListFormatting||this.btnBoxFormatting||this.btnCssText||this.btnCssBuilder)
          ...
          sHTMLDropMenus+="<table class=\"DropMenus\" id=dropStyle"+this.oName+" cellpadding=0 cellspacing=0 "+
            "style='line-height:normal;z-index:1;display:none;position:absolute;border:#80788D 1px solid;"+
            "cursor:default;background-color:#fbfbfd;' unselectable=on>"+
            sTmp+"</table>";
          }
      ...
      case "Paragraph":
        if(this.btnParagraph)
          {
          sHTMLDropMenus+="<table class=\"dropParagraph\" id=dropParagraph"+this.oName+" cellpadding=0 cellspacing=0 "+
            "style='line-height:normal;z-index:1;display:none;position:absolute;border:#80788D 1px solid;"+
            "cursor:default;background-color:#fbfbfd;' unselectable=on>";
      ...
      case "FontName":
        if(this.btnFontName)
          {
          sHTMLDropMenus+="<table class=\"dropFontName\" id=dropFontName"+this.oName+" cellpadding=0 cellspacing=0 "+
            "style='line-height:normal;z-index:1;display:none;position:absolute;border:#80788D 1px solid;"+
      ...
      case "FontSize":
        if(this.btnFontSize)
          {
          sHTMLDropMenus+="<table class=\"dropFontSize\" id=dropFontSize"+this.oName+" cellpadding=0 cellspacing=0 "+
            "style='line-height:normal;z-index:1;display:none;position:absolute;border:#80788D 1px solid;"+
            "cursor:default;background-color:#fbfbfd;' unselectable=on>";
      ...
      case "Table":
        if(this.btnTable)
          {
          sHTMLDropMenus+="<table class=\"dropTable\" id=dropTable"+this.oName+" cellpadding=0 cellspacing=0 "+
            "style='line-height:normal;z-index:1;display:none;position:absolute;border:#80788D 1px solid;"+
            "cursor:default;background-color:#fbfbfd;' unselectable=on>"+
          ...
          sHTMLDropMenus+="<table width=195 class=\"dropTableCreate\" id=dropTableCreate"+this.oName+" onmouseout='doOut_TabCreate();event.cancelBubble=true' style='position:absolute;display:none;cursor:default;background:#f3f3f8;border:#8a867a 1px solid;' cellpadding=0 cellspacing=2 border=0 unselectable=on>";
          for(var m=0;m<8;m++)
            {
            sHTMLDropMenus+="<tr>";
            for(var n=0;n<8;n++)
      ...
      case "RemoveFormat":
        ...
        break;
      case "HTMLFullSource":
        if(this.btnHTMLFullSource)sHTMLIcons+=this.writeIconStandard("btnHTMLFullSource"+this.oName,"setActiveEditor('"+this.oName+"');"+this.oName+".hide();modalDialogShow('"+this.scriptPath+"source_html_full.htm',600,450);","btnSource.gif",getTxt("View/Edit Source"),35);
        break;
      case "HTMLSource":
        if(this.btnHTMLSource)sHTMLIcons+=this.writeIconStandard("btnHTMLSource"+this.oName,"setActiveEditor('"+this.oName+"');"+this.oName+".hide();modalDialogShow('"+this.scriptPath+"source_html.htm',600,450);","btnSource.gif",getTxt("View/Edit Source"),35);
        break;
      case "XHTMLFullSource":
        if(this.btnXHTMLFullSource)sHTMLIcons+=this.writeIconStandard("btnXHTMLFullSource"+this.oName,"setActiveEditor('"+this.oName+"');"+this.oName+".hide();modalDialogShow('"+this.scriptPath+"source_xhtml_full.htm',600,450);","btnSource.gif",getTxt("View/Edit Source"),35);
        break;
      case "XHTMLSource":
        if(this.btnXHTMLSource)sHTMLIcons+=this.writeIconStandard("btnXHTMLSource"+this.oName,"setActiveEditor('"+this.oName+"');"+this.oName+".hide();modalDialogShow('"+this.scriptPath+"source_xhtml.htm',600,450);","btnSource.gif",getTxt("View/Edit Source"),35);
        break;
      case "ClearAll":
...
function showColorPicker(oEl)
  ...
  box.style.top=nTop+1+oUtil.obj.dropTopAdjustment+24;//[CUSTOM]

  box.style.zIndex='99999';
  //added on 2007-06-11 by LJ
...
function loadHTML(sHTML)//hanya utk first load.
  ...
  var sStyle="";
  if(this.css!="") {
	  sStyle="<link href='"+this.css+"' rel='stylesheet' type='text/css'>"
  }else{
      sStyle="<style>body{margin: 5px; font:12px arial,sans-serif;}</style>"	  
	}
...
function realTime(oName,bTagSel)
  ...
  if(obj.useTagSelector && !bTagSel)
    ...
    while (oElement!=null && oElement.tagName!="BODY")
      ...
      sHTML = "&nbsp; &lt;<span id=tag"+oName+i+" unselectable=on style='text-decoration:underline;cursor:hand;font-size:10px' onclick=\""+oName+".selectElement("+i+")\">" + sTagName + "</span>&gt;" + sHTML;
      oElement = oElement.parentElement;
      i++;
      }
    sHTML = "&nbsp;&lt;BODY&gt;" + sHTML;
...
function doClick_TabCreate()
  ...
  for(var i=1;i<=nRow;i++)
    ...
    for(var j=1;j<=nCol;j++)
      {
      sHTML+="<td style='border:#666666 1px solid;'></td>";
      }
    sHTML+="</tr>";
    }
  sHTML+="</table>";
...
function fullScreen()
  ...
  if(this.stateFullScreen)
	...
	document.getElementById("TableBody").style.cssText="";
	document.getElementById("chk_idAll").style.cssText="";
	if(document.getElementById("TableBody_thead")!=null)document.getElementById("TableBody_thead").style.cssText="";
	if(document.getElementById("dTab12")!=null)document.getElementById("dTab12").style.cssText="";
	if(document.getElementById("dTab14")!=null)document.getElementById("dTab14").style.cssText="";
	if(document.getElementById("codestr_div")!=null)document.getElementById("codestr_div").style.cssText="position: relative; ";
	...
	document.getElementById("TableBody").style.cssText="height:auto!important;";
	document.getElementById("chk_idAll").style.cssText="height:auto!important;";
	if(document.getElementById("TableBody_thead")!=null)document.getElementById("TableBody_thead").style.cssText="display: none;";
	if(document.getElementById("dTab12")!=null)document.getElementById("dTab12").style.cssText="text-align: left; ";
	if(document.getElementById("dTab14")!=null)document.getElementById("dTab14").style.cssText="text-align: left; ";
	if(document.getElementById("dTab14")!=null)document.getElementById("dTab14").style.cssText="text-align: left; ";
	if(document.getElementById("codestr_div")!=null)document.getElementById("codestr_div").style.cssText="display: none; ";
    eval("idArea"+this.oName).style.position="absolute";
    eval("idArea"+this.oName).style.top=0;
    eval("idArea"+this.oName).style.left=0;
...
function dropShow(oEl,box)
  ...
  box.style.top=nTop+1+this.dropTopAdjustment+24;
...
function writeIconToggle(id,command,img,title)
  ...
  sHTML=""+
    ...
    "<span unselectable='on' style='position:absolute;clip: rect(0 "+w+"px "+h+"px 0);width:"+w+"px;height:"+h+"px;background-image:url("+imgPath+"); background-repeat:repeat-x;'"+
    "name=\""+id+"\" id=\""+id+"\" btnIndex=\""+buttonArraysCount+"\"" +
...
function writeIconStandard(id,command,img,title,width)
  ...
  sHTML=""+
    ...
    "onmouseout='doOut(this)' "+
    "onmousedown='doDown(this)' "+
    "onmouseup=\"if(doUp(this)){"+command+"}\" title=\""+title+"\">"+
    "</span></td>";
  sHTML="<table align=left cellpadding=0 cellspacing=0 style='table-layout:fixed;'><tr>"+sHTML+"</tr></table>";
  buttonArrays.push(["inactive"]);
  buttonArraysCount++;
...
function writeDropDown(id,command,img,title,width)
  ...
  sHTML=""+
    "<td unselectable='on' style='padding:0px;padding-right:1px;VERTICAL-ALIGN: top;margin-left:0;margin-right:1px;margin-bottom:1px;width:"+w+"px;height:"+h+"px;'>"+
    "<span name=\""+id+"\" id=\""+id+"\" btnIndex=\""+buttonArraysCount+"\" unselectable='on' style='position:absolute;clip: rect(0 "+w+"px "+h+"px 0);background-image:url("+imgPath+"); background-repeat:repeat-x;height:"+h+"px;width:"+w+"px' onmouseover='doOver(this)' onmouseout='doOut(this)' onmousedown='doDown(this)' onmouseup=\"if(doUp(this)){"+command+"}\" title=\""+title+"\">"+
    "</span></td>";
  sHTML="<table align=left cellpadding=0 cellspacing=0 style='table-layout:fixed;'><tr>"+sHTML+"</tr></table>";
  buttonArrays.push(["inactive"]);
  buttonArraysCount++;
...
function doOver(btn)
  ...
  if(btnArr[0]=="inactive")btn.style.backgroundPosition="0 "+-iconHeight+"px";//no.2
  }
function doDown(btn)
  {
  btnArr=buttonArrays[btn.btnIndex];
  //if(btnArr[0]!="disabled")btn.style.top=-iconHeight*2;//no.3
  if(btnArr[0]=="disabled")btn.style.backgroundPosition="0 "+-iconHeight*2+"px";//no.3
  }
var bCancel=false;
function doOut(btn)
  {
  ...
  if(btnArr[0]=="active")btn.style.backgroundPosition="0 "+-iconHeight*3+"px";//no.4 (remain active/pushed)
  if(btnArr[0]=="inactive")btn.style.backgroundPosition="0 0";//no.1 (remain inactive)
  }
function doUpToggle(btn)
  {
  if(bCancel)
    {//lagi pushed tapi mouseout (cancel)
    bCancel=false;btn.style.backgroundPosition="0 0";
    return false;
    }
  btnArr = buttonArrays[btn.btnIndex];
  if(btnArr[0]=="inactive")
	...
	btn.style.backgroundPosition="0 "+-iconHeight*3+"px"
    btnArr[0]="active";
    return true;
    }
  if(btnArr[0]=="active")
	...
	btn.style.backgroundPosition="0 "+-iconHeight+"px"
    btnArr[0]="inactive";
    return true;
    }
  }
...
function makeDisabled(btn)
  ...
  btn.style.backgroundPosition="0 "+-iconHeight*4+"px"
  }
