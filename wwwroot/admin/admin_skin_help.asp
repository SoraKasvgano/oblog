...
<br>
<table width="90%" border="0" align=center cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" class="border"><tr align="center">
  ...
  <tr>
    <td height=23 class="tdbg style1">$show_music$</td>
    <td height=23 class="tdbg style1">此标记显示aobo音乐盒 </td>
  </tr>
  <tr>
    <td height=23 class="tdbg style1">$show_userid$</td>
    <td height=23 class="tdbg style1">此标记显示用户ID</td>
  </tr>
  <tr>
<td height=23 colspan="2" class="tdbg"><strong><font color=#0000ff>副模板：</font><br>
  ...
  <tr>
    ...
    <td height=23 class="tdbg"> 此标记显示阅读全文(次数)，回复(次数)，引用链接。</td>
		...
		<table width="90%" border="0" align=center cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" class="border">
		  <tr align="center">
            <td height=25 colspan="2" class="topbg"><strong>群组模板标记说明</strong>
                  <tr>
                    <td height=23 colspan="2" class="tdbg"><strong><font color=#0000ff>主模板：</font><br>
                    </strong>主模板为页面的主体部分，包括css样式设置等，建议在Dreamweave或Frontpage中编辑，完成后将代码copy进来。 </td>
                  </tr>
                  <tr>
                    <td height=23 class="tdbg"> $group_name$ </td>
                    <td height=23 class="tdbg"> 此标记调用的是圈子名称 。</td>
                  </tr>
                  <tr>
                    <td height=23 class="tdbg"> $group_url$ </td>
                    <td height=23 class="tdbg"> 此标记调用的是圈子的地址

。</td>
                  </tr>
                  <tr>
                    <td height=23 class="tdbg"> $group_guide$ </td>
                    <td height=23 class="tdbg"> 此标记调用的是导航条

。 </td>
                  </tr>
                  <tr>
                    <td height=23 class="tdbg"> $group_info$ </td>
                    <td height=23 class="tdbg"> 此标记调用的是圈子的相关信息（圈子标记图片，圈子名称，创建者，创建时间等）

。</td>
                  </tr>
                  <tr>
                    <td height=23 class="tdbg"> $group_admin$ </td>
                    <td height=23 class="tdbg"> 标记调用的是管理员的头像和名称

。</td>
                  </tr>
                  <tr>
                    <td height=23 class="tdbg"> $group_comments$ </td>
                    <td height=23 class="tdbg"> 此标记调用的是圈子中的最新回复 。</td>
                  </tr>
                  <tr align="left">
                    <td height=23 class="tdbg"> $group_posts$ </td>
                    <td height=23 class="tdbg"> 此标记调用的是圈子中的最新文章 <span class="style2">。</span></td>
                  </tr>
                  <tr>
                    <td height=23 class="tdbg"> $group_photo$ </td>
                    <td height=23 class="tdbg"> 此标记调用的是圈子中的最新相片

。</td>
                  </tr>
                  <tr>
                    <td height=23 class="tdbg"> $group_bestposts$ </td>
                    <td height=23 class="tdbg"> 此标记调用的是圈子中的精华文章

。</td>
                  </tr>
                  <tr>
                    <td height=23 class="tdbg"> $group_placard$ </td>
                    <td height=23 class="tdbg"> 此标记调用的是圈子公告

。</td>
                  </tr>
                  <tr>
                    <td height=23 class="tdbg"> group_bestuser$ </td>
                    <td height=23 class="tdbg"> 此标记调用的是活跃成员 。</td>
                  </tr>
                  <tr align="left">
                    <td height=23 class="tdbg"> $group_newuser$ </td>
                    <td height=23 class="tdbg"><span class="style2"> 此标记调用的是最新成员 。</span></td>
                  </tr>
                  <tr align="left">
                    <td height=23 class="tdbg"> $group_links$ </td>
                    <td height=23 class="tdbg"><span class="style2"> 此标记调用的是友情链接 。</span></td>
                  </tr>
                  <tr>
                    <td height=23 class="tdbg"> $group_bottom$ </td>
                    <td height=23 class="tdbg"> 此标记调用的是站点版权信息（系统后台网站信息配置中设置的版权信息）
...
。</td>
                  ...
                  <tr>
                    <td height=23 class="tdbg"> $group_list$ </td>
                    <td height=23 class="tdbg"><strong>  此标记调用的是圈子主体部分
...
。</strong></td>
                  ...
                  <tr>
                    <td height=23 class="tdbg"> $group_url$ </td>
                    <td height=23 class="tdbg"> 此标记调用的是圈子的地址 。</td>
                  </tr>
                  <tr>
                    <td width="18%" height=23 class="tdbg"> $group_guide$ </td>
                    <td width="82%" class="tdbg"> 此标记调用的是导航条 。</td>
                  </tr>
                  <tr>
                    <td height=23 class="tdbg"> $group_placard$ </td>
                    <td height=23 class="tdbg"> 此标记调用的是圈子公告 。</td>
                  </tr>
                  <tr>
                    <td height=23 class="tdbg"> $group_bestuser$ </td>
                    <td height=23 class="tdbg"> 此标记调用的是活跃成员 。</td>
                  ...
                  <tr>
                    <td height=23 class="tdbg"> $group_admin$ </td>
                    <td height=23 class="tdbg"> 此标记调用的是管理员的头像和名称

。</td>
                  </tr>
                  <tr>
                    <td height=23 class="tdbg"> $group_bottom$ </td>
                    <td height=23 class="tdbg"> 此标记调用的是站点版权信息（系统后台网站信息配置中设置的版权信息）</td>
                  </tr>
        </table>
		<p>&nbsp;</p>
	  </div>
