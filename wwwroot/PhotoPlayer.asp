...
sql="select Top 100 * From oblog_album Where TeamID=0 and (ishide=0 OR ishide IS NULL ) "
'Response.Write Now()
If classid<>"" Then
...
Else
	...
	For i=1 To picNumber
  		ImgJS = ImgJS & "ImgName[" & i & "]=""" &  rst("photo_path") & """;" & VBCRLF
  		rst.MoveNext
  	Next
End If
rst.Close
...
<div align="center">
  ...
  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="458">
      ...
      <p align="center"><b><font color="#000000">oBlog<%=oblog.ver%> 图片自动播放器</font></b><BR/><BR/></td>
    </tr>
   ...
   <tr>
      <td width="458" class="photobox" align=center valign=middle>
      	<BR/>
      <center><img src="<%=blogurl%>images/photoconver.gif" name="img" onload="if(this.width>=400)this.width=400;" onclick="window.open(img.src);" style="cursor:hand"></center>
      	<BR/>
    </tr>
  </table>
  </center>
